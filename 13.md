...
1. 80/tcp open http Apache httpd 2.4.7 ((Ubuntu))
   ...
   สิ่งที่ต้องโฟกัส: มีรายชื่อรหัสช่องโหว่ CVE ยาวต่อเนื่องกันหลายช่องโหว่ ตรวจพบรหัสช่องโหว่ใหม่และเก่าที่มีคะแนนความรุนแรง สูงถึง 9.8 และ 10.0 เป็นจำนวนมาก (ถ้ามีสถานะระบุชัดเจนว่า *EXPLOIT* แปลว่าช่องโหว่เหล่านี้มีโค้ดสำหรับใช้ยิงเพื่อยึดระบบเผยแพร่อยู่บนอินเทอร์เน็ตแล้ว)
